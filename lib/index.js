...
module.exports = function(options, done) {
    ...
    var message = [
        'Database:',
        '    ' + options.hostname + ':' + options.port + ' (DB: ' + options.database + ')',
        '',
        'Scripts:',
        '    Schema: ' + (options.schemaLocation || '(not specified)'),
        '    Routines: ' + (options.routinesLocation || '(not specified)'),
        ''
    ];
    consoleWriter.happy(message.join('\n'));
